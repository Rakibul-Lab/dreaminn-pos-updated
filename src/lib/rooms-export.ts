...
const STATUS_COLORS: Record<string, { fill: Rgb; text: Rgb; label: string }> = {
  ...
  CLEANING: { fill: [100, 116, 139], text: [255, 255, 255], label: 'Dirty' },
  IN_PROGRESS: { fill: [100, 116, 139], text: [255, 255, 255], label: 'Dirty' },
  MAINTENANCE: { fill: [239, 68, 68], text: [255, 255, 255], label: 'Maintenance' },
}
...
const PDF_TABLE_COLUMNS = [
  ...
  { header: 'Total/night', width: 28, value: (r: RoomExportRecord) => formatBdtForPdf(r.basePrice) },
